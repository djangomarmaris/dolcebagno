...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/%y/%m/%d', blank=True,verbose_name='500x500')
...
class Images(models.Model):
    ...
    image = models.ImageField(blank=True, upload_to='images/',verbose_name='868x655')
